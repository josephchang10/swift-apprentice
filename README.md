...
因为你已经被训练使用十进制，就不需要思考怎么阅读大部分数字了——感觉相当自然。但对电脑来说，十进制太复杂了！还记得吗，电脑头脑简单？它们喜欢用二进制。

**二进制**每一位只有两个选项：0 或 1。

几乎所有现代计算机都使用二进制，因为在物理层面，每位两种情况是最容易处理的。在数字电子电路里，正是由它们构成了大部分电脑，电压存在是1，缺失是0——这就是二进制！

**注意：**曾经有想象的和真实的三进制系统电脑，有三个可能值而不是两个。计算机科学家、工程师和具有奉献精神的黑客继续在探索三进制电脑的可能性。参考 [https://en.wikipedia.org/wiki/ Ternary_computer ] 和 [http://hackaday.com/tag/ternary-computer/ ]
